...
let name = "Gian Carlo"; //number,string,boolean,null,function,object
let age = 22;
let isSingle = true;
let hobbies = ['basketball', 'mobile games']
let jsonObject = {name: name, age: age, isSingle: isSingle, hobbies: hobbies}
let run = function () {
